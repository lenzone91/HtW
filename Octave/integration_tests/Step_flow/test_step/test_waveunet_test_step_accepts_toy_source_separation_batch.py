"""
Integration test for WaveUNet test-step compatibility with toy TSE batches.

This file validates that a batch produced by the real toy source-separation
DataModule can be consumed by the WaveUNet LightningModule test_step.
"""
...
def test_waveunet_test_step_accepts_toy_source_separation_batch(tmp_path) -> None:
