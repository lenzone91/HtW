"""
Integration test for WaveUNet training-step compatibility with toy TSE batches.

This file validates that a batch produced by the real toy source-separation
DataModule can be consumed by the WaveUNet LightningModule training_step.
"""
...
def test_waveunet_training_step_accepts_toy_source_separation_batch(tmp_path) -> None:
