"""
Integration test for WaveUNet validation-step compatibility with toy TSE batches.

This file validates that a batch produced by the real toy source-separation
DataModule can be consumed by the WaveUNet LightningModule validation_step.
"""
...
def test_waveunet_validation_step_accepts_toy_source_separation_batch(tmp_path) -> None:
    ...
    # Validation is called under torch.no_grad()
    with torch.no_grad():
