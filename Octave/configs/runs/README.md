...
`module.metric_set_config` contains metric construction and routing settings.

`module.loss_config` contains weighted-loss aggregation settings.

DataModule phase configs use one named child object per enabled phase:
